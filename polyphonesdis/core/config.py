...
from polyphonesdis.core.io import cache_url, pathmgr
...
_C.MODEL.VOCAB_SIZE = 4000
_C.MODEL.TAGS_SIZE = 100
_C.MODEL.CWS_SIZE = 5
_C.MODEL.POS_SIZE = 29
_C.MODEL.FLAG_SIZE = 1
_C.MODEL.EMBEDDING_DIM = 64
_C.MODEL.NUM_LAYER = 1
_C.MODEL.HIDDEN_DIM = 64
_C.MODEL.PRETRAINED_EMBEDDING_DIM = 200
_C.MODEL.DROPOUT_EMBEDDING = 0.3
_C.MODEL.DROPOUT_LINEAR = 0.3
_C.MODEL.DROPOUT_BLSTM = 0.3
_C.MODEL.DROPOUT_INTER_BLSTM=0.0
