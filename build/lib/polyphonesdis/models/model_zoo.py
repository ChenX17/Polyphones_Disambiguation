...
from polyphonesdis.core.config import cfg, load_cfg, reset_cfg
from polyphonesdis.core.io import cache_url
...
def beatnet(name, pretrained=False, cfg_list=()):
    """Constructs a BeatNet model (note: loads global config as well)."""
    name = name if "BeatNet-" in name else "BeatNet-" + name
