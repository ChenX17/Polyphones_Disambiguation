...
def train_epoch(loader, model, ema, cls_loss_fun, loc_loss_fun, optimizer, scaler, meter, cur_epoch):
...
def train_model():
    ...
    for cur_epoch in range(start_epoch, cfg.OPTIM.MAX_EPOCH):
        # Train for one epoch
        params = (train_loader, model, ema, cls_loss_fun, loc_loss_fun, optimizer, scaler, train_meter)
